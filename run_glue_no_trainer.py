...
def parse_args():
    ...
    parser.add_argument(
        ...
        help="Truncation strategy to use. Can be ('longest_first', 'only_first', 'only_second', 'True', 'False')",
    )
    parser.add_argument(
        "--pad_to_max_length",
        action="store_true",
...
def main():
    ...
    if args.task_name is not None:
        ...
        raw_datasets = load_from_disk("/home/huyiwen/datasets/" + args.task_name)
        print(raw_datasets)
    else:
    ...
    def preprocess_function(tokenizer, sentence1_key, sentence2_key, padding, max_length, truncation, label_to_id):
    ...
    with accelerator.main_process_first():
        processed_datasets = raw_datasets.map(
            preprocess_function(tokenizer, sentence1_key, sentence2_key, padding, args.max_length, truncation, label_to_id),
            batched=True,
    ...
    if args.task_name is not None:
        metric = evaluate.load("./glue.py", args.task_name)
    else:
